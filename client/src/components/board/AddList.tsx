...
export default function AddList({ boardId }: AddListProps) {
  ...
  if (!isAdding) {
    return (
      <button
        ...
        className="w-[27rem] flex-shrink-0 bg-white/30 hover:bg-white/50 text-white rounded-xl px-3 py-2 text-sm text-left transition-colors"
      >
        + Add another list
      </button>
    );
  ...
  return (
    <div className="w-[27rem] flex-shrink-0 bg-gray-200 rounded-xl p-2">
